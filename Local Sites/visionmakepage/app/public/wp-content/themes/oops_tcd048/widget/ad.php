   	...
   	echo $before_widget;
		...
		if ( 0 === $random ) {
			if ( $banner_code1 ) { 
				...
				echo '<a href="' . esc_url( $banner_url1 ) . '" target="_blank"><img src="' . esc_attr( $banner_image1[0] ) . '" alt=""></a>' . "\n"; 
			}
		} elseif ( 1 === $random ) {
			if ( $banner_code2 ) { 
				echo $banner_code2;
			} else { 
				echo '<a href="' . esc_url( $banner_url2 ) . '" target="_blank"><img src="' . esc_attr( $banner_image2[0] ) . '" alt=""></a>' . "\n"; 
			}
		} elseif ( 2 === $random ) {
			if ( $banner_code3 ) { 
				echo $banner_code3; 
			} else { 
				echo '<a href="' . esc_url( $banner_url3 ) . '" target="_blank"><img src="' . esc_attr( $banner_image3[0] ) . '" alt=""></a>' . "\n"; 
			}
		}
		...
		<?php for ( $i = 1; $i <= 3; $i++ ) : ?>
			...
			<div class="ml_ad_widget_box">
  			<div class="ml_ad_widget_box_inner">
    			<h4 class="ml_ad_widget_sub_headline"><?php _e( 'Register AdSense code','tcd-w' ); ?></h4>
  			...
  			<div class="ml_ad_widget_box_inner">
    			<h4 class="ml_ad_widget_sub_headline"><?php _e( 'Register AdSense image', 'tcd-w' ); ?></h4>
  			...
  			<div class="ml_ad_widget_box_inner">
   				<h4 class="ml_ad_widget_sub_headline"><?php _e( 'Register affiliate code or link url for registered image', 'tcd-w' ); ?></h4>
