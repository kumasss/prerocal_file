...
function add_custom_meta_boxes() {
	add_meta_box( 'wp_recommend_post', __( 'Recommend post', 'tcd-w' ), 'recommend_post', 'post', 'side' );
}
...
<ul>
	...
	<li>
		<label><input type="checkbox" name="recommend_post3" value="on" <?php checked( $recommend_post3, 'on', true ); ?>><?php _e( 'Show this post for recommend post3.', 'tcd-w' ); ?></label>
	</li>
</ul>
<?php
}
...
function save_recommend_post_meta_box( $post_id ) {
  ...
  $cf_keys = array( 'recommend_post', 'recommend_post2', 'recommend_post3' );
