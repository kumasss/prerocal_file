...
// type1, type2, type3, type4
	...
	if ( 'type1' == $options['sns_type_top'] ) {
		$top_class = 'c-share--sm c-share--color';
	} elseif ( 'type2' == $options['sns_type_top'] ) {
		$top_class = 'c-share--sm c-share--mono';
	} elseif ( 'type3' == $options['sns_type_top'] ) {
		$top_class = 'c-share--lg c-share--color';
	} elseif ( 'type4' == $options['sns_type_top'] ) {
