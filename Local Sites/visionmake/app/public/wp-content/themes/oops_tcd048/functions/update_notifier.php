...
?>
    ...
    <div class="wrap">
   		...
   		<div id="message" class="updated below-h2">
   			<p><strong><?php echo esc_html( $theme_data['Name'] ); ?>の最新版が公開されています。</strong> 現在利用しているバージョンは「<?php echo esc_html( $theme_data['Version'] ); ?>」です。 「<?php echo esc_html( $xml->latest ); ?>」に更新する事ができます。</p>
     	</div>
     	<div id="mono_instructions">
     		<h3>注意事項：最新版にアップデートする際は、必ずテーマの<strong>バックアップ</strong> をしてください。</h3>
            <p style="font-size:16px;">【 <a href="http://tcdwp.info/dl048/oops/oops_tcd048.zip">最新版のテーマをダウンロードする</a> 】</p>
     		<div id="mono_info">
   				<h3>更新情報</h3>
...
function get_latest_theme_version( $interval ) {
	...
	$notifier_file_url = 'http://design-plus1.com/notifier_oops.xml';	
	$db_cache_field = 'oops-contempo-notifier-cache';
	$db_cache_field_last_updated = 'oops-contempo-notifier-last-updated';
