...
// type1, type2, type3, type4
	...
	if ( 'type1' == $options['sns_type_btm'] ) {
		$btm_class = 'c-share--sm c-share--color';
	} elseif ( 'type2' == $options['sns_type_btm'] ) {
		$btm_class = 'c-share--sm c-share--mono';
	} elseif ( 'type3' == $options['sns_type_btm'] ) {
		$btm_class = 'c-share--lg c-share--color';
	} elseif ( 'type4' == $options['sns_type_btm'] ) {
...
?>
			  	<a href="http://twitter.com/share?text=<?php echo $title_encode ?>&url=<?php echo $url_encode ?>&via=<?php echo $options['twitter_info']; ?>&tw_p=tweetbutton&related=<?php echo $options['twitter_info']; ?>">
<?php
		else :
?>
			    <a href="http://twitter.com/share?text=<?php echo $title_encode ?>&url=<?php echo $url_encode ?>&via=<?php echo $options['twitter_info']; ?>&tw_p=tweetbutton&related=<?php echo $options['twitter_info']; ?>"  onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=400,width=600');return false;">
<?php
		endif;
?>
