...
<div class="blogs form">
	...
	<input type="hidden" value="<?php echo $form_data['scenario_id'];?>" name="scenario_id" >
...
<?php if(isset($form_data['id']) && $form_data['id'] !==""):?>
	...
	<button type="submit" value="prev_edit" class="btn btn-primary" style="margin-right:5px"><i class="icon-ok icon-white" style="margin:1px 2px 0 0;"></i>ストーリー保存</button>
	<button type="submit" value="edit" class="btn btn-default" style="margin-right:5px">戻る</button>
<?php else: ?>
	<button type="submit" value="prev_add" class="btn btn-primary" style="margin-right:5px"><i class="icon-ok icon-white" style="margin:1px 2px 0 0;"></i>ストーリー保存</button>
	<button type="submit" value="add" class="btn btn-default" style="margin-right:5px">戻る</button>
<?php endif;?>
	</div>
</form>
</div>
