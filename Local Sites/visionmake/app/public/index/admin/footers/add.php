...
elseif(isset( $message )) {
	...
	echo '<div class="waku">フッターのテンプレートを作成します。';
	echo '</div>';
}
?>
<div class="row">
...
<span class="red">*</span>フッター</label>
<div class="controls required">
<textarea id="HeaderContent" class="span8" cols="5" rows="10" style="height:300px" name="footer"><?php echo $form_data['footer']; ?></textarea>
</div>
</div>
</div><!--end of span-->
<div class="span4">
...
<button type="submit" class="btn btn-primary" style="margin-right:5px;">保存</button><a class="btn" href="<?php echo URL; ?>/admin/footers/">キャンセル</a></div></form>
</div>
</div>
</div>
</body>
