...
<input type="hidden" value="log_delete" name="status">
...
?>
		<tr>
			...
			<td><?php echo $logsObj->html_decode( $col['title'] ); ?></td>
...
?>
	...
	<?php require_once(dirname(__FILE__).'/../../common/element/logs_page_link.php'); ?>
	</div>
</div>
</div>
</body>
