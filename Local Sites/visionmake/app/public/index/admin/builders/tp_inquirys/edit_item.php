...
<?php require_once( '../../../../common/element/tab_form_setting.php'); ?>
...
?>
  ...
  <tr>
    ...
    <td class="taC"><a href="./edit_item/index.php?mode=edit&id=<?php echo $linesArray[0];?>" class="editBtn<?php echo $dispNonFlag;?>">編集</a><input type="hidden" name="sort[]" value="<?php echo $linesArray[0];?>" /></td>
  </tr>
