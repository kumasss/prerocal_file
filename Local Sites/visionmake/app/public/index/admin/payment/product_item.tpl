							...
							<div id="update-form" class="modal-body">
								...
								<div class="row">
										...
										<div class="control-group">
											...
											<input name="title" id="prd-title" class="form-control  span4" maxlength="30" placeholder="30文字まで" value="#{$editdata->title}"></input>
										</div>

										<div class="control-group">
											<div class="span1">説明</div>
											<textarea name="description" id="prd-desc" class="form-control  span4" rows="6" maxlength="200" placeholder="200文字まで" value="">#{$editdata->description}</textarea>
										</div>
