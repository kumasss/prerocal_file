	...
	tinymce.create('tinymce.plugins.MediaPlugin', {
		init : function(ed, url) {
			...
			ed.onNodeChange.add(function(ed, cm, node) {
				...
				if(tinymce.plugins.QuickUploadVideoPlugin){
					cm.setActive('quickuploadvideo', node && node.nodeName === 'IMG' && ed.dom.hasClass(node, 'mceItemVideo') );
				}
				// audio upload button active
				if(tinymce.plugins.QuickUploadAudioPlugin)
					cm.setActive('quickuploadaudio', node && node.nodeName === 'IMG' && ed.dom.hasClass(node, 'mceItemAudio') );
