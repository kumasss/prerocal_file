...
$base_path = str_replace('common/js/tiny_mce/plugins/quickuploadvideo/upload.php','',str_replace('\\','/',__FILE__));
$base_url  = str_replace('common/js/tiny_mce/plugins/quickuploadvideo/upload.php','',$_SERVER['SCRIPT_NAME']);
...
<script>
	var FileDialog = {
		init : function(ed)
		{
			...
			tinyMCEPopup.editor.dom.createHTML('video',
			{
